...
public class SVGRadialGradient extends SVGObject {
	 ...
	 */
	public SVGRadialGradient(String id, String style, float x1, float y1, float x2, float y2, String stop1_color, String stop2_color, 
	 ...
	 */
	public SVGRadialGradient(Element e) {
		super(e);
